...
<layout-card class="space-y-5">
    <div class="flex items-center">
        ...
        <button class="border rounded p-2 ml-auto hover:text-tufts-blue hover:border-tufts-blue">
...
import { EllipsisHorizontalIcon, HeartIcon, ChatBubbleOvalLeftEllipsisIcon, ShareIcon } from '@heroicons/vue/24/outline';
